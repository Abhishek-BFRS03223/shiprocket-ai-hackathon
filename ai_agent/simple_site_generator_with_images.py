"""
Enhanced One-Click Site Generator with Dynamic Images
Adds professional images using free placeholder APIs
"""
...
class SimpleSiteGeneratorWithImages:
    """Enhanced website generator with dynamic image support"""
    ...
    def _generate_images(self, analysis: Dict[str, Any]) -> Dict[str, str]:
        """Generate image URLs using free placeholder APIs"""
        product_name = analysis["product_name"]
        
        # Create unique seed based on product name for consistent images
        seed = hashlib.md5(product_name.encode()).hexdigest()[:10]
        
        images = {
            # Hero image - large banner
            "hero_image": f"https://picsum.photos/seed/{seed}-hero/1200/600",
            
            # Feature images - smaller square images
            "feature_1": f"https://picsum.photos/seed/{seed}-f1/400/300",
            "feature_2": f"https://picsum.photos/seed/{seed}-f2/400/300", 
            "feature_3": f"https://picsum.photos/seed/{seed}-f3/400/300",
            
            # Product showcase image
            "product_image": f"https://picsum.photos/seed/{seed}-product/500/400",
            
            # Testimonial avatars
            "avatar_1": f"https://picsum.photos/seed/{seed}-av1/80/80",
            "avatar_2": f"https://picsum.photos/seed/{seed}-av2/80/80",
        }
    ...
    def analyze_product(self, product_name: str) -> Dict[str, Any]:
        ...
        # Add dynamic images
        analysis["images"] = self._generate_images(analysis)
    ...
    def generate_content(self, analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        content = {
            "hero": {
                ...
                "background_image": analysis["images"]["hero_image"]
            },
            "features": {
                ...
                "features_list": [
                    {
                        ...
                        "image": analysis["images"][f"feature_{i+1}"]
            ...
            "benefits": {
                ...
                "showcase_image": analysis["images"]["product_image"]
            },
            "testimonials": {
                ...
                "testimonials": [
                    {
                        ...
                        "avatar": analysis["images"]["avatar_1"]
                    },
                    {
                        "name": "Mike Chen",
                        "role": "Business Owner", 
                        "text": f"Game-changer! {product_name} revolutionized our workflow.",
                        "avatar": analysis["images"]["avatar_2"]
                    }
                ]
            },
            "pricing": {
    ...
    def generate_html(self, analysis: Dict[str, Any], content: Dict[str, Any]) -> str:
        """Generate complete HTML website with images"""
...
<body>
    ...
    <!-- Benefits Section with Showcase Image -->
    <section class="section">
        <div class="container">
            <h2 class="section-title">{benefits['section_title']}</h2>
            <div class="benefits-grid">
                <div>
                    <img src="{benefits['showcase_image']}" alt="{product_name} showcase" class="showcase-image">
                </div>
                <div>
        ...
        for testimonial in testimonials['testimonials']:
            html += f"""
                <div class="testimonial">
                    ...
                    <div class="testimonial-author">{testimonial['name']}<br><small>{testimonial['role']}</small></div>
                </div>"""
    ...
    <section class="section contact" id="contact">
        <div class="container">
            ...
            <p style="margin-top: 30px; opacity: 0.8;">{contact['contact_info']}</p>
        </div>
    </section>
</body>
</html>"""
    ...
    def generate_website(self, product_name: str) -> Dict[str, Any]:
        """Generate a complete website for the given product"""
        try:
            ...
            print(f"🎨 Creating HTML website with images for: {product_name}")
            ...
            return {
                ...
                "generation_method": "Enhanced Template Engine with Images",
                "html": html,
                "analysis": analysis,
                "content": content
            }
    ...
    def save_website(self, result: Dict[str, Any], output_dir: str = "generated_sites") -> str:
        """Save the generated website to disk"""
        if not result.get("success"):
            raise Exception("Cannot save failed generation result")
        
        product_name = result["product_name"]
        safe_name = re.sub(r'[^a-zA-Z0-9\s]', '', product_name).lower().replace(' ', '_')
        ...
        metadata_path = os.path.join(site_dir, "metadata.json")
...
def demo():
    """Demo the enhanced site generator with images"""
    print("🎯 ENHANCED SITE GENERATOR WITH IMAGES DEMO")
    print("=" * 50)
    ...
    generator = SimpleSiteGeneratorWithImages()
    
    for product in products:
        print(f"\n🚀 Generating site with images for: {product}")
        result = generator.generate_website(product)
        
        if result["success"]:
            site_dir = generator.save_website(result)
            print(f"✅ Success! Saved to: {site_dir}")
            print(f"🖼️ Images included: Hero, Features, Showcase, Avatars")
